...
class BasePage(object):
    ...
    # 架构接口地址-正式环境
    def api_url_normal(self):
        base_url = 'http://120.76.26.4:9081/jesse/dubbpApi/'
        return base_url

    # 架构接口地址-测试环境（本地）
    def api_url_test(self):
        base_url = 'localhost:9081/jesse/dubbpApi/'
        return base_url


    def get_headers(self):
        headers = {
            'Cookie': 'JSESSIONID=2FDEF4B6C6A47EDC083E50C74E8BCD0D'
        }
        return headers
