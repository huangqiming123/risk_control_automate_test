...
if __name__ == '__main__':
    ...
    test_dir_account_center = test_runner_path.test_cases_path('loan_customer')

    # 指定测试报告目录
    test_report_account_center = test_runner_path.test_report_path('loan_customer')
    ...
    # 定义报告存放路径
    filename_account_center = test_report_account_center + '\\' + now + '_loan_customer.html'
