...
class TestCase03UserManageAddUserException2(unittest.TestCase):
    # 测试用户管理新增用户功能异常情况
    def setUp(self):
    ...
    def test_add_user_exception2(self):
        # 通过csv测试新增用户功能异常情况
        ...
        csv_file = self.user_management_read_csv.read_csv('add_user_exception2.csv')
        ...
        for row in csv_data:
            ...
            # 获取异常提示
            text = self.user_management.get_add_user_exception2()
