...
class TestCase03RoleManageAddRoleException2(unittest.TestCase):
    # 测试角色管理新增角色功能异常情况
    def setUp(self):
    ...
    def test_add_role_exception2(self):
        # 通过csv测试新增角色功能异常情况
        ...
        csv_file = self.role_management_read_csv.read_csv('add_role_exception2.csv')
        ...
        for row in csv_data:
            ...
            # 获取异常提示
            text = self.role_management.get_add_role_exception2()
